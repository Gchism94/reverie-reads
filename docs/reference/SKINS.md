...
1. **App name vs skin name.** "Reverie" becomes the **romance skin's** name; the
   generalized **app needs its own name** (reshapes `docs/reference/TRADEMARK.md`). Decide the app
...
> This generalization is also the growth play (`docs/reference/SCALING.md`) — a general, highly
...
coding agent task when Phase 5 tracks land.
