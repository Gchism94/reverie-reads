...
Derived from the real Library_App_list.xlsx (490 rows), which is NOT in Claude Code's repo. I1-I3 were
...
Drop the real Library_App_list.xlsx into Claude Code's data/raw/ (gitignored) and run I1-I3:
