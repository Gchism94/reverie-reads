...
> how the app behaves today. This is the current possession model. `docs/reference/DATA_MODEL.md` carries
> the shipped shape. For current behavior, read the code and `docs/reference/DATA_MODEL.md`.
