...
- [ ] **Enrichment Edge Function:** cover/metadata lookup runs server-side
      (Google Books → Open Library → Hardcover per `docs/reference/DATA_SOURCES.md`), cached,
      rate-limit-aware.
...
- [ ] Walk `docs/reference/REQUIREMENTS.md` top to bottom; confirm each ✅/◑/⭐ item works in the
