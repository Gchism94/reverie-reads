...
Paste into Claude Code. A parallel data-layer track alongside the skin track (C2–C4). Same working
...
## D1 — Enrichment aggregator (implements docs/reference/ENRICHMENT_STRATEGY.md)
...
never drop the seed; user-authored fields always win in any merge; stay within docs/reference/SCALING.md cost
