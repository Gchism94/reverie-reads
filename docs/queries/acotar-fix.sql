...
-- dd33f8da carries `user_edited = true` (placed 2026-07-15). CLAUDE.md's hard rule is that a
...
-- is invisible to me" (CLAUDE.md: a check that cannot tell those apart passes in the safe-looking
-- direction).
--
