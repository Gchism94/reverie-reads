...
**Sources & caveats** (`docs/DATA_SOURCES.md`): Google Books → Open Library → Hardcover.
...
> Recommended: a short **design tool** pass for the desktop screens (sidebar +
...
5. **Desktop design** → do a design tool pass first (recommended), or have coding agent
