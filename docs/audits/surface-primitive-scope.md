...
| ----: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **0** | Build `Surface` + its unit tests + `surface-visual.audit.ts` + capture the `main` baseline. **Zero call sites migrated.** **Status: component + tests done; the harness captures but its baseline is not yet stable — see the audit script's KNOWN LIMITATION. Batch 1 is blocked on that reaching 0.** |     0 | The instrument must exist and be trusted before it measures anything. A batch that ships the component _and_ migrates sites cannot tell a component bug from a migration bug.                                                                                |
