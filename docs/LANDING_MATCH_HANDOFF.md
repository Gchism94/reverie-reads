# Landing page — Claude Code handoff

Source (Claude Design): "Reverie Landing" project — gold genre-neutral revision (pink confined to the
...
this project:
https://claude.ai/design/p/4cd3eb88-1d0f-4316-b7fd-2a5887083970?file=Reverie+Landing.dc.html
