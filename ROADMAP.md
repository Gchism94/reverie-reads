...
|     4 |    P0    | Build independent, corpus-preserving library membership  | Owner verification due | PR #364 integrated the reviewed bounded backfill and corpus-admin preservation history. The owner reports both migrations applied in order; item 4 closes only after the read-only production report confirms their current postconditions. See `docs/queries/library-membership-rollout-verification.sql`, `docs/tasks/task-library-removal-and-reconciliation.md`, and `docs/tasks/task-corpus-admin-enrichment.md`.                                                                      |
