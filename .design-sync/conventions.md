...
```html
<html data-skin="tryst" data-mode="dark">
  <!-- everything below now themed Tryst/dark -->
</html>
```
...
>
  ...
  <p style="font-family: var(--font-sans); color: var(--muted);">
    A gothic hush over the night shelf.
  </p>
  <button
    style="border: none; border-radius: 999px; padding: 9px 16px;
