...
# uncommitted work in it, silently, with nothing recoverable. AGENTS.md has carried "commit before
...
#     note: `.agent-tooling/hooks/pretooluse-guard.sh` now blocks it outright for coding agent sessions and
#     redirects here.
#
