...
│   └── DESIGN_PROMPT.md     prompt for generating the refreshed UI
│
├── docs/                specs & research
...
## For the build phase (coding agent)

Start with **`AGENTS.md`** (coding agent loads it automatically) and
`docs/CODING_AGENT_KICKOFF.md` (sequenced build plan).
