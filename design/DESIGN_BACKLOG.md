...
- Auth screens -- HANDED OFF -> design/from-claude-design/auth/HANDOFF.md (genre-neutral gold brand; sign up / log in / verify email / forgot + reset / edge states incl. rate-limited).
...
- Cover Studio (NEW; see docs/COVER_SOURCING_AND_STUDIO.md) -- personal cover-curation surface, NOT a
  ...
  PROMPT WRITTEN -> design/CLAUDE_DESIGN_PROMPT_COVER_STUDIO.md (per-book editor + batch triage [batch-first, scales] + photograph-your-copy + placeholder across skins).
