...
//
// HAND-MIRRORED from packages/core/src/embedding.ts (the source of truth) for the Deno runtime,
// kept honest by packages/core/src/embedParity.test.ts — exactly like the enrich merge mirror.
// Change the composition THERE first; the sig changes → the sweep re-embeds.
