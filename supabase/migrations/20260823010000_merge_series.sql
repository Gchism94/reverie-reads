...
-- position actually changed. This is not a silent override of AGENTS.md's hard rule — invoking this
...
begin
  ...
  --      exact pair is replaced, not duplicated — AGENTS.md's precedent: the protection guards
