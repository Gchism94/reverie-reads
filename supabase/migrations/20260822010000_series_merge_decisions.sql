...
-- exact class of defect this repo's own AGENTS.md keeps naming (a stored fact two writers can
...
-- mind — AGENTS.md's Wings-and-Ruin precedent: the protection guards against silent algorithmic
