-- works — the shared corpus, and works-layer Phase 1 (agent/task-works-layer-scope.md; owner
...
-- wanted, it arrives as a reviewed RPC with the full revoke-then-grant treatment (AGENTS.md's RPC
