...
-- AGENTS.md's hard rule: never silently overwrite a reader-set position. Phase 0 confirmed the flag
...
-- half and the grant is additive (AGENTS.md). `from anon` BY NAME as well: 20260806010000 records
