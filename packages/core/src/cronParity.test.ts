...
const LIBRARIES: Record<string, Book[]> = {
  romanceHeavy: [
    makeBook({ id: '1', title: 'A', subgenre: 'Romance', tags: ['Slow Burn', 'Small Town'], rating: 5, fave: true, readStatus: 'Read' }),
    makeBook({ id: '2', title: 'B', subgenre: 'Contemporary', tags: ['Fake Dating'], rating: 4, readStatus: 'Read' }),
  ],
  fantasyHeavy: [
    makeBook({ id: '3', title: 'C', subgenre: 'Romantasy', tags: ['Fae', 'Fated Mates'], rating: 5, fave: true, readStatus: 'Read' }),
    makeBook({ id: '4', title: 'D', subgenre: 'Fantasy', tags: ['Magic Academy', 'Chosen One'], rating: 3, readStatus: 'Read' }),
  ],
  scifiAndDark: [
    makeBook({ id: '5', title: 'E', subgenre: 'Science Fiction', tags: ['Space', 'AI'], rating: 4, readStatus: 'Read' }),
    makeBook({ id: '6', title: 'F', subgenre: 'Dark Romance', tags: ['Mafia', 'Possessive'], rating: 2, readStatus: 'DNF' }),
  ],
  thinAndUnread: [
    makeBook({ id: '7', title: 'G', subgenre: 'Romance', tags: [], rating: 0, readStatus: 'Unread' }),
  ],
  empty: [],
  mixedBag: [
    makeBook({ id: '8', title: 'H', subgenre: 'Sports', tags: ['Grumpy/Sunshine'], rating: 4, readStatus: 'Read' }),
    makeBook({ id: '9', title: 'I', subgenre: 'Horror', tags: ['Stalker', 'Obsessive'], rating: 5, fave: true, readStatus: 'Read' }),
    makeBook({ id: '10', title: 'J', subgenre: 'Dystopian', tags: ['Cyberpunk'], rating: 1, readStatus: 'Read' }),
  ],
}
